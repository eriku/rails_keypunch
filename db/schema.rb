...
ActiveRecord::Schema.define(version: 20120710231044) do
  ...
  add_index "entity_groups", ["entity_id", "group_id"], name: "index_entity_groups_on_entity_id_and_group_id", using: :btree
  ...
  add_index "entity_roles", ["entity_id", "role_id"], name: "index_entity_roles_on_entity_id_and_role_id", unique: true, using: :btree
  ...
  add_index "entity_users", ["entity_id", "user_id"], name: "index_entity_user_on_entity_id_and_user_id", unique: true, using: :btree
